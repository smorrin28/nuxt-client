<template>
	<div>
		...
		Verbinde jetzt dein kompatibles Wallet mit deinem Account und lege fest,
		...
		<div class="selection">
			...
			/>
			<base-input type="checkbox" label="Zeugnisse und Zertifikate" />
			<base-input
				type="checkbox"
		...
		<div>
			...
			<base-button v-if="templateID" design="success" @click="acceptRequest"
				><base-icon source="material" icon="check" />Anfrage
				annehmen</base-button
			>
